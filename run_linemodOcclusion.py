...
# python run_linemodOcclusion_1.py --linemod_dir  /home/yluo/GSPose/dataspace/lmo --use_reconstructed_mesh 0
...
def run_pose_estimation_worker(reader, i_frames, est:OneRefPose=None, debug=0, ob_id=None, device='cuda:0', evaluator=None, model_pts=None, error_dict=None):
...
def run_pose_estimation():
  ...
  est = OneRefPose(model_pts=mesh_tmp.vertices.copy(), model_normals=mesh_tmp.vertex_normals.copy(), symmetry_tfs=None, mesh=mesh_tmp, scorer=None, refiner=None, debug_dir=debug_dir, debug=debug)
